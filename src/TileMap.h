...
enum class Tile {
	...
	LADDER_TOP = 40, LADDER, LADDER_BOTTOM, STONE_WITH_1_DOWN, STONE_WITH_3_DOWN, STONE_WITH_4_DOWN, STONE_WITH_2_DOWN, STONE_WITH_5_DOWN, STONE_WITH_6_DOWN, DOOR_TOP_LEFT,DOOR_MID_LEFT, 
	DOOR_BOTTOM_LEFT,DOOR_TOP_MID, DOOR_MID_MID, DOOR_BOTTOM_MID, DOOR_TOP_RIGHT, DOOR_MID_RIGHT, DOOR_BOTTOM_RIGHT,
	
	WATER_L = 60, WATER_R,
	// 50 <= id < 100: special tiles

	KEY = 70, OBJECT, EXP, PONER_LLAVE,
